...
function addNewContent(obj) {
	...
	for(var a = 0; a < imgSrc.length; a++) {
		var that = this;
		var oldBox = $(obj).html();
		$(obj).html(oldBox + '<div class="imgContainer"><img title=' + imgName[a] + ' alt=' + imgName[a] + ' src=' + imgSrc[a] + ' οnclick="imgDisplay('+that+')" height="200px"><p οnclick="removeImg('+that+',' + a + ')" class="imgDelete">删除</p></div>');
	}
}
//删除
